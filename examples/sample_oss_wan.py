...
def _parse_args():
    ...
    parser.add_argument(
        ...
        action="store_true",
        default=False,
        help="Using half feature as cost.")
    parser.add_argument(
        "--random_channel",
        action="store_true",
        default=False,
        help="Using the random channel selection.")
...
def generate(args):
    ...
    if "t2v" in args.task or "t2i" in args.task:
        ...
        logging.info(f"Using order: {args.solver_order}")
        video = wan_t2v.generate(
            ...
            random_channel=args.random_channel,
            )
    else:
        if args.prompt is None:
            args.prompt = EXAMPLE_PROMPT[args.task]["prompt"]
