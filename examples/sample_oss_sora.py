...
def parse_args(training=False):
    ...
    if not training:
        ...
        parser.add_argument("--teacher-steps", default=None, type=int,help="number of teacher steps")
        parser.add_argument("--student-steps", default=None, type=int,help="number of student steps")
...
def merge_args(cfg, args, training=False):
    ...
    if not training:
        ...
        if args.teacher_steps is not None:
            cfg.scheduler["teacher_steps"] = args.teacher_steps
            args.teacher_steps = None
        if args.student_steps is not None:
            cfg.scheduler["student_steps"] = args.student_steps
            args.student_steps = None
