    ...
    for i in progress_wrap(range(0, len(prompts), batch_size)):
        ...
        for k in range(num_sample):
            ...
            for loop_i in range(loop):
                ...
                samples_oss, samples_tea = scheduler.sample(
                    model,
                    text_encoder,
                    z=z,
                ...
                samples_oss = vae.decode(samples_oss.to(dtype), num_frames=num_frames)
                samples_tea = vae.decode(samples_tea.to(dtype), num_frames=num_frames)
